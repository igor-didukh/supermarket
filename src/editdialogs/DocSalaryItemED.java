...
public class DocSalaryItemED extends EditDialog implements ActionListener {
	...
	public DocSalaryItemED(Entity ent, EditDialogDoc parentDialog) {
		...
		comboUser.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				txtPremiaRef.setText("" + user.getWorker().getPremia());
	...
	protected Entity entityFromFields() {
		...
		return
			new DocSalaryItem(
				id,
				user.getId(),
				user.getWorker().getImie(),
				user.getWorker().getNazwisko(),
