...
public class RefProductDM extends DataManager {
	...
	public ArrayList<Entity> getEntityList() {
		return super.getListFromRS("SELECT * FROM produkty");
	}
	...
	public void addEntity(Entity ent) {
		...
		String sql = "INSERT INTO produkty ("
				+ "nazwa, "
				+ "unit, "
				+ "punkty, "
				+ "dlugosc_gwarancji, "
	...
	public void updateEntity(Entity ent) {
		...
		String sql = "UPDATE produkty SET "
				+ "nazwa='%s', "
				+ "unit='%s' , "
				+ "punkty='%s' , "
				+ "dlugosc_gwarancji='%s', "
	...
	public void deleteEntity(int id) {
		String sql = String.format("DELETE FROM produkty WHERE id=%d", id);
		super.executeUpdate(sql);
	}
